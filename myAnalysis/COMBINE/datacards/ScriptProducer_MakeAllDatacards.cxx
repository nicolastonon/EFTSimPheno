...
void Script_Datacards_TemplateFit(char include_systematics, char include_statistical, TString template_name, TString region, vector<TString> v_templates, vector<TString> v_channel, vector<TString> v_regions)
{
	...
	ofstream file_out("Create_Datacards_TemplateFit.sh"); //output script
...
*/
	...
	system("chmod 755 Create_AllDatacards_TemplateFit.sh");

	cout<<FGRN("... Created script ./Create_AllDatacards_TemplateFit.sh !")<<endl;

	cout<<endl<<endl<<FGRN("-- Executing script ./Create_AllDatacards_TemplateFit.sh !")<<endl;

	system("./Create_AllDatacards_TemplateFit.sh");
