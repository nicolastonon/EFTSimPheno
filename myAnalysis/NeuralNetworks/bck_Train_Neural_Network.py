...
def Get_Data_Keras(signal, bkg_type, var_list, cuts, _nof_outputs, _maxEvents):
...
def Train_Test_Eval_PureKeras(bkg_type, var_list, cuts, _nepochs, _batchSize, _nof_outputs, _maxEvents, _splitTrainEventFrac):
    ...
    #Get data
    x_train, y_train, x_test, y_test, weightPHY_train, weightPHY_test, weightLEARN_train, weightLEARN_test, x, y, weightPHY, weightLEARN = Get_Data_Keras(signal, bkg_type, var_list, cuts, _nof_outputs, _maxEvents)
