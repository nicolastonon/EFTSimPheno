...
# with command line options: Configuration/GenProduction/python/PrivProd.py --mc --conditions auto:run2_mc -n 100 --era Run2_25ns --eventcontent RAWSIM --step GEN --datatier GEN --beamspot Realistic25ns13TeVEarly2017Collision --filein file:cmsgrid_final_tzq.lhe --fileout file:GEN.root --python_filename GEN_cfg.py --no_exec
...
#    fileNames = cms.untracked.vstring("root://cms-xrd-global.cern.ch//store/user/sewuchte/ttJProduction/v0/LHE_Input/out.lhe"),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/PrivProd.py nevts:100'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(123)
